  ...
  return (
    <section className="relative flex min-h-dvh items-center px-4 py-8 sm:px-8 lg:px-12 xl:px-20">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 h-72 w-72 rounded-full bg-[#fb7185]/[0.07] blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto w-full max-w-md">
        ...
        <div className="mt-8">
          ...
          <p className="mt-2 text-sm leading-6 text-[#948e9c]">
            Create your VoyageAI account and start planning smarter trips with an AI travel companion.
          </p>
        </div>
        ...
        <button
          type="button"
          className="mt-7 flex h-11 w-full items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-white/[0.03] text-sm font-medium text-[#cbc4d2] transition hover:bg-white/[0.06] hover:text-[#e6e0e8]"
        >
          <GoogleIcon />
        ...
        {/* Login */}
        <p className="mt-6 text-center text-xs text-[#948e9c]">
